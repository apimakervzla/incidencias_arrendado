...
<div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
              <strong class="card-title">Lista de Lugares</strong>
              
              <a href="{{ route('create.tbllugares')}}" class="card-category">
            ...
            <div class="table-responsive">              
              <table class="table listas">                 
                  <thead>
                    ...
                    <tbody>
                      {{-- dd($incidencias) --}}
                    @foreach($lugares as $puntero=>$valor)
                    <tr>
                        <td>
                        ...
                        {{-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-info_{{$puntero}}">
                            ...
                            <button style="font-size: 1.2rem" type="button" rel="tooltip" title="" onclick="location.href='{{ route('edit.tbllugares',['id'=>$valor->id])}}'" class="btn btn-white btn-link btn-sm" data-original-title="Ver">                             
