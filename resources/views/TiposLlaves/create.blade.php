        ...
        <div class="row">
          ...
          <div class="col-md-12">
                <div class="box box-warning">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" >                        
                        <form method="POST" role="form" action="{{ route("store.tiposllaves")}}" enctype="multipart/form-data" >
                          @csrf
                            <!-- textarea -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="tiempo_expira" id="tiempo_expira" class="form-control select2" style="width: 100%;" data-placeholder="Seleccione">                                        
                                                    <option value="00:30:00">30 m</option>
                                                    <option value="01:00:00">1 h</option>
                                                    <option value="02:00:00">2 h</option>
                                                    <option value="03:00:00">3 h</option>
                                                    <option value="04:00:00">4 h</option>
                                                    <option value="05:00:00">5 h</option>
